...
@Config
@Autonomous(group = "a")
public class DuckBlueWarehouseFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        switch (markerPosition)
        {
            case RIGHT:
                ...
                book.BlueRightWarehouseParkFar(drive.getPoseEstimate());
