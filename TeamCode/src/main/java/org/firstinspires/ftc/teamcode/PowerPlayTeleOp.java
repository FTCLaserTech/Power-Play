...
public class PowerPlayTeleOp extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (!isStopRequested())
        {
            ...
            telemetry.addLine()
                    .addData("Red ", extras.testColorSensor.red())
                    .addData("Green ", extras.testColorSensor.green())
                    .addData("Blue ", extras.testColorSensor.blue());
            telemetry.addData("Alpha ", extras.testColorSensor.alpha());
