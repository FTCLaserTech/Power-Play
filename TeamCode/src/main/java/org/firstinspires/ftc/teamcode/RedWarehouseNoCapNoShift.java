 ...
 * your follower PID coefficients such that you follow the target position as accurately as        ExtraOpModeFunctions extras = new ExtraOpModeFunctions(hardwareMap, this);
 possible.
...
@Config
@Autonomous(group = "c")
public class RedWarehouseNoCapNoShift extends LinearOpMode {
